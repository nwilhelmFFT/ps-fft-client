...
export interface FacilityCarrierConnection extends VersionedResource {
   ...
   */
  configuration?:
    | DhlFacilityCarrierConfiguration
...
export interface PackingContainerPatchActions {
   ...
   */
  actions: Array<
    | ReplaceCodesInPackingContainerAction
    | AddLineItemToPackingContainerAction
    | RemoveLineItemFromPackingContainerAction
    | UpdateLineItemOnPackingContainerAction
  >;
  /**
   * The version of the document to be used in optimistic locking mechanisms.
   * @type {number}
